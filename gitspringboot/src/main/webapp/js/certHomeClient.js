...
app.run(function(defaultErrorMessageResolver){
	defaultErrorMessageResolver.getErrorMessages().then(function (errorMessages){
		errorMessages['tooYoung']='you must be at least {0} years old to use this';
		errorMessages['tooOld']='you must be max {0} years old to use this yes';
		errorMessages['badUsername']='Username can contain numbrs';
...
app.controller('MinMaxCtrl',function($scope,$http){
	$scope.formModel={};
	$scope.submitBtn=function(valid){
		if(valid){
		console.log("Hey i am submitted="+valid);
	...
	$scope.selectedRow=function(index,person){
